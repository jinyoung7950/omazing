...
<!-- 	<button type="button" class="btn btn-primary btn-lg"
	...
	<!-- Modal -->
	<div class="modal fade" id="personal_info_modal" tabindex="-1" role="dialog"
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<div class="input-group">
									<input type="text" class="form-control" value="생년월일을 선택하세요">
						...
						<div class="form-group">
							...
							<label for="gender" class="col-md-2 control-label">성별</label> <label
								class="radio-inline"> <input type="radio" name="gender"
								id="female" value="female"> 여성
							</label> <label class="radio-inline"> <input type="radio"
								name="gender" id="male" value="male"> 남성
							</label>
